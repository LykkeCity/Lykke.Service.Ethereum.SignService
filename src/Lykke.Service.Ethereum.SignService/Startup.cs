...
using Lykke.Service.Ethereum.SignService.Core.Settings;
using Lykke.Service.Ethereum.SignService.Models;
using Lykke.Service.Ethereum.SignService.Modules;
...
namespace Lykke.Service.Ethereum.SignService
{
    public class Startup
    {
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            //var dbLogConnectionStringManager = settings.Nested(x => x.EthereumSignServiceService.Db.LogsConnString);
            ...
            //        AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "EthereumSignServiceLog", consoleLogger),
            //        consoleLogger);
            //
